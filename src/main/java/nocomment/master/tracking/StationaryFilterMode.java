...
public class StationaryFilterMode extends AbstractFilterMode {
	...
	public void decommission() {
		System.out.println("Stationary tracked for " + totalClock + " seconds, used " + hitCount + " checks, "
				+ Math.round(1000 * (float) hitCount / (float) totalClock) / 1000f + " cps, dimension "
				+ parent.context.world.dimension + ", at " + pos);
	}
