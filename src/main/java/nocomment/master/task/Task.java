...
public abstract class Task extends PriorityDispatchable {
	...
	public boolean interchangeable(Task other) {
		return priority == other.priority && start.equals(other.start) && directionX == other.directionX
				&& directionZ == other.directionZ && count == other.count;
	}
	...
	public class InterchangeabilityKey {
		...
		private int hashCode = priority * 39587 + start.hashCode() + directionX * 5349 + directionZ * 34698
				+ count * 37894;
		...
		public boolean equals(Object o) {
			return this == o
					|| (o instanceof InterchangeabilityKey && ((InterchangeabilityKey) o).interchangeable(Task.this));
		}
