...
public class TestTelegramMessageSplitter {
	...
	private static String withoutChar(String str, char filterChar) {
		return str.chars().filter(c -> c != filterChar)
	...
	public void testSplitter() {
		...
		final String randomString = rand.ints(1_000_000, 0, 255)
		...
		// The original string can't be fully reconstructed but ignoring new lines they
		// will be the same
